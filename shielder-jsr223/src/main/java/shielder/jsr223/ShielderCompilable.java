...
public interface ShielderCompilable extends Compilable {

    @Override
    ShielderCompiledScript compile(Reader script) throws ScriptException;

    @Override
    ShielderCompiledScript compile(String script) throws ScriptException;
}
